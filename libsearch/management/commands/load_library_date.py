...
from libsearch.models import EventDetails
from pytz import UTC


DATETIME_FORMAT = '%m/%d/%Y %H:%M %a'
...
If you need to reload the library event data from the CSV file,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if EventDetails.objects.exists():
            print('Library event data already loaded...exiting.')
